...
namespace WindowsFormsApp1 {
    ...
    public partial class AdminData : global::System.Data.DataSet {
        ...
        public partial class AdminsDataTable : global::System.Data.TypedTableBase<AdminsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AdminsRow AddAdminsRow(string Name, string Email, string Username, string Passwords, string Role) {
        ...
        public partial class AdminsRow : global::System.Data.DataRow {
            ...
            public string Passwords {
                get {
                    return ((string)(this[this.tableAdmins.PasswordsColumn]));
                }
                set {
                    this[this.tableAdmins.PasswordsColumn] = value;
                }
            }
...
namespace WindowsFormsApp1.AdminDataTableAdapters {
    ...
    public partial class AdminsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Admins] WHERE (([AdminID] = @Original_AdminID) AND ([Name] = @" +
                ...
                "ame) AND ([Passwords] = @Original_Passwords) AND ([Role] = @Original_Role))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Admins] ([Name], [Email], [Username], [Passwords], [Role]) VAL" +
                "UES (@Name, @Email, @Username, @Passwords, @Role);\r\nSELECT AdminID, Name, Email," +
                " Username, Passwords, Role FROM Admins WHERE (AdminID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Admins] SET [Name] = @Name, [Email] = @Email, [Username] = @Username, [Passwords] = @Passwords, [Role] = @Role WHERE (([AdminID] = @Original_AdminID) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Username] = @Original_Username) AND ([Passwords] = @Original_Passwords) AND ([Role] = @Original_Role));
SELECT AdminID, Name, Email, Username, Passwords, Role FROM Admins WHERE (AdminID = @AdminID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AdminID, Name, Email, Username, Passwords, Role FROM dbo.Admins";
        ...
        public virtual int Fill(AdminData.AdminsDataTable dataTable) {
        ...
        public virtual AdminData.AdminsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdminData.AdminsDataTable dataTable = new AdminData.AdminsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdminData.AdminsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_AdminID, string Original_Name, string Original_Email, string Original_Username, string Original_Passwords, string Original_Role) {
        ...
        public virtual int Insert(string Name, string Email, string Username, string Passwords, string Role) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string Username, string Passwords, string Role, int Original_AdminID, string Original_Name, string Original_Email, string Original_Username, string Original_Passwords, string Original_Role, int AdminID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Username, string Passwords, string Role, int Original_AdminID, string Original_Name, string Original_Email, string Original_Username, string Original_Passwords, string Original_Role) {
            return this.Update(Name, Email, Username, Passwords, Role, Original_AdminID, Original_Name, Original_Email, Original_Username, Original_Passwords, Original_Role, Original_AdminID);
        }
    }
